...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("CG 图鉴") action ShowMenu("gallery_screen")

        textbutton _("结局图鉴") action ShowMenu("ending_gallery_screen")
...
screen about():
    ...
    use game_menu(_("关于"), scroll="viewport"):
        ...
        vbox:
            ...
            text "引擎：{a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only]"
